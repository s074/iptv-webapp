...
> [!NOTE]  
> This application does not provide any data or media, and only displays data from the user provided Xtream Codes API url
...
runs in the browser and talks directly to your Xtream Codes API.
